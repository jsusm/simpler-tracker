...
function RouteComponent() {
  ...
  const { mutateAsync: deleteActivityMutation } = useMutation({
    mutationFn: deleteActivitySF, onSuccess() {
                ...
                <AlertDialogContent size="sm">
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will delete all the metrics and records you have registered.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel variant="outline">Cancel</AlertDialogCancel>
                    <AlertDialogAction variant="destructive" onClick={handleDeleteActivity}>Delete</AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
              </AlertDialog>
            </div>
